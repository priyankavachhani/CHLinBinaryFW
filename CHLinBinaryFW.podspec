#
#  Be sure to run `pod spec lint CHLinBinaryFW.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  Cocoa pod library to make and receive calls.
                   DESC

  spec.homepage     = "https://github.com/priyankavachhani/CHLinBinaryFW"
  ...
  spec.source_files  = "CHLinBinaryFW/*.{h,m}"
